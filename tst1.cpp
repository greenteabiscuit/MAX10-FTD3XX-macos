...
int main(int argc, char *argv[])
{
	...
	get_version();
    cout << "get version function executed" << endl;
    ...
    cout << "FT_Create was executed" << endl;
	if (!handle) {
    ...
    cout << chipConfig.FIFOClock << endl;
